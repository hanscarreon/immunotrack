...
$sql = "INSERT INTO children2 
(ch_first_name, ch_last_name, ch_vaccine, ch_vac_date, ch_bod, ch_guardian_fname, ch_guardian_lname, ch_street, ch_brgy, ch_city, ch_number) 
VALUES 
(
'" . $ch_first_name . "', 
'" . $ch_last_name . "',
